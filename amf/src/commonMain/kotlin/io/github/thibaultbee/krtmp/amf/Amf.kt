...
class Amf0 {
    /**
     * The default instance of [Amf0]
     */
    companion object Default : Amf(AmfConfiguration(AmfVersion.AMF0), EmptySerializersModule())
}

class Amf3 {
    /**
     * The default instance of [Amf3]
     */
    companion object Default : Amf(AmfConfiguration(AmfVersion.AMF3), EmptySerializersModule())
}
...
sealed class Amf(
    ...
    /**
     * Encodes to [AmfElement].
     *
     * [AmfElement] is agnostic of the Amf version.
     */
...
fun Amf(from: Amf = Amf0, builderAction: AmfBuilder.() -> Unit): Amf {
