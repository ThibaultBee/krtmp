...
abstract class PacketWriter {
     ...
     */
    fun readBuffer(): Buffer {
        return Buffer().apply { writeToSink(this) }
    }
    ...
    /**
     * Reads the frame as a [RawSource].
     * The purpose of this method is to avoid copying the packet to a temporary buffer.
     *
     * @return the [RawSource] containing the frame
     */
    open fun readRawSource(): RawSource {
        return readBuffer()
    }
}