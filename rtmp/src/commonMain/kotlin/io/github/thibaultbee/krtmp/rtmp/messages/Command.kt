...
open class Command(
    ...
    class OnStatus(
        ...
        Amf.encodeToAmfElement(
            NetStreamOnStatusInformation.serializer(), information
        )
    ) {
        @Serializable
...
fun CommandNetConnectionResult(
    ...
    return Command.Result(
        ...
        timestamp,
        Amf.encodeToAmfElement(
            NetConnectionResultObject.serializer(), connectReplyObject
        ),
        Amf.encodeToAmfElement(
            NetConnectionResultInformation.serializer(), NetConnectionResultInformation(
                level = "status",
